 ...
 */
public class ChildViewPagerBackup1 extends ViewPager {

    private float mDownX;
    private float mDownY;

    public ChildViewPagerBackup1(Context context) {
        super(context);
    }

    public ChildViewPagerBackup1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
